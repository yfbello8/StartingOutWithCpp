...
void quit_program() {
	cout << "Thank you for checking out Chapter 7 Programming Assignments! "
...
void Menu() {
	...
	while (choice != QUIT_PROGRAM) {
		...
		while (choice != QUIT_PROGRAM) {
			...
			cout << endl;
			cout << "Here are the questions for Chapter 7 - Arrays" << endl;
...
int main() {
	cout << "\t Chapter 7: Arrays " << endl;
	cout << "This program displays the Programming Challenges in Chapter 7" << endl << endl;
